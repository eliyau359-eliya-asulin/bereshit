...
(function(global){
  ...
  const PRODUCTS = [
    { id:1, sku:'KID-VRD-01', cat:'kiddush', catLabel:'גביעי קידוש', name:'גביע קידוש "ורדית"', price:420, oldPrice:null, badge:'new',
      ...
      material:'כסף סטרלינג 925', dim:'גובה 16 ס״מ, קוטר 7 ס״מ',
      stock:9, threshold:4, status:'active', sold:34 },
    { id:2, sku:'CND-ORZ-02', cat:'candles', catLabel:'פמוטים', name:'זוג פמוטי "אור זך"', price:640, oldPrice:760, badge:'sale',
      ...
      material:'פליז מצופה כסף מוברש', dim:'גובה 14 ס״מ ליחידה',
      stock:3, threshold:4, status:'active', sold:27 },
    { id:3, sku:'SHB-PTS-03', cat:'shabbat', catLabel:'מוצרי שבת', name:'סכין חלה מוכספת "פטיש"', price:340, oldPrice:null, badge:null,
      ...
      material:'כסף מצופה, פלדת אל-חלד', dim:'אורך 33 ס״מ',
      stock:14, threshold:5, status:'active', sold:41 },
    { id:14, sku:'SHB-SVT-14', cat:'shabbat', catLabel:'מוצרי שבת', name:'סכין חלה חרוטה "שבת ויום טוב"', price:420, oldPrice:null, badge:'new',
      ...
      material:'כסף מצופה, פלדת אל-חלד', dim:'אורך 34 ס״מ',
      stock:2, threshold:5, status:'active', sold:18 },
    { id:4, sku:'HAV-BSM-04', cat:'havdalah', catLabel:'הבדלה', name:'סט הבדלה "בשמים"', price:520, oldPrice:null, badge:'new',
      ...
      material:'כסף מצופה, בסיס עץ', dim:'סט הכולל 3 פריטים',
      stock:7, threshold:4, status:'active', sold:22 },
    { id:5, sku:'GFT-MZD-05', cat:'gifts', catLabel:'מתנות', name:'מזוזת כסף מעוצבת', price:210, oldPrice:null, badge:null,
      ...
      material:'כסף מצופה, עבודת פיליגרן', dim:'12 ס״מ',
      stock:20, threshold:6, status:'active', sold:55 },
    { id:6, sku:'SLV-MRV-06', cat:'silverware', catLabel:'כלי כסף', name:'סט קינוח "מרווה" (6 יח\')', price:340, oldPrice:390, badge:'sale',
      ...
      material:'כסף מצופה, גימור מט', dim:'אורך 13 ס״מ ליחידה',
      stock:11, threshold:5, status:'active', sold:30 },
    { id:7, sku:'KID-MIN-07', cat:'kiddush', catLabel:'גביעי קידוש', name:'גביע קידוש "מינימל"', price:340, oldPrice:null, badge:null,
      ...
      material:'כסף סטרלינג מוברש', dim:'גובה 13 ס״מ',
      stock:0, threshold:4, status:'out', sold:15 },
    { id:8, sku:'SLV-ELP-08', cat:'silverware', catLabel:'כלי כסף', name:'מגש הגשה "אליפסה"', price:480, oldPrice:null, badge:'new',
      ...
      material:'כסף מצופה מלוטש', dim:'34×22 ס״מ',
      stock:6, threshold:4, status:'active', sold:12 },
    { id:9, sku:'KID-ZMR-09', cat:'kiddush', catLabel:'גביעי קידוש', name:'גביע קידוש "זמורה"', price:390, oldPrice:null, badge:'new',
      ...
      material:'כסף 925, פנים מוזהב', dim:'גובה 17 ס״מ',
      stock:8, threshold:4, status:'active', sold:19 },
    { id:10, sku:'MEN-KNC-10', cat:'menorahs', catLabel:'חנוכיות', name:'חנוכיית "קונכית כסף"', price:560, oldPrice:null, badge:'new',
      ...
      material:'כסף מצופה מלוטש', dim:'גובה 22 ס״מ',
      stock:5, threshold:5, status:'active', sold:24 },
    { id:11, sku:'MEN-KSH-11', cat:'menorahs', catLabel:'חנוכיות', name:'חנוכיית "קשת"', price:610, oldPrice:680, badge:'sale',
      ...
      material:'כסף מצופה מלוטש', dim:'רוחב 30 ס״מ',
      stock:9, threshold:5, status:'active', sold:31 },
    { id:12, sku:'MEN-ASF-12', cat:'menorahs', catLabel:'חנוכיות', name:'חנוכיית "אספנים" מפוארת', price:1450, oldPrice:null, badge:'new',
      ...
      material:'כסף מצופה 925, גימור מלוטש', dim:'גובה 34 ס״מ',
      stock:2, threshold:3, status:'active', sold:6 },
    { id:13, sku:'MEN-TCH-13', cat:'menorahs', catLabel:'חנוכיות', name:'חנוכיית תחרה חרוטה', price:495, oldPrice:null, badge:null,
      ...
      material:'כסף מצופה', dim:'גובה 16 ס״מ',
      stock:13, threshold:5, status:'active', sold:17 },
    { id:15, sku:'GFT-KTR-15', cat:'gifts', catLabel:'מתנות', name:'מזוזת כתר מפוספסת', price:260, oldPrice:null, badge:'new',
      ...
      material:'כסף מצופה מלוטש', dim:'גובה 20 ס״מ',
      stock:16, threshold:6, status:'active', sold:28 },
    { id:16, sku:'GFT-PRH-16', cat:'gifts', catLabel:'מתנות', name:'מזוזת פרחים עתיקה', price:295, oldPrice:null, badge:null,
      ...
      material:'כסף מצופה', dim:'גובה 11 ס״מ',
      stock:10, threshold:6, status:'draft', sold:4 },
    { id:17, sku:'CND-SHS-17', cat:'candles', catLabel:'פמוטים', name:'מנורת שישה קנים', price:780, oldPrice:null, badge:'new',
      ...
      material:'כסף מצופה מלוטש', dim:'גובה 32 ס״מ',
      stock:4, threshold:4, status:'active', sold:9 },
  ];

  const CATEGORIES = [
    { key:'kiddush', label:'גביעי קידוש', status:'active' },
    { key:'candles', label:'פמוטים', status:'active' },
    { key:'menorahs', label:'חנוכיות', status:'active' },
    { key:'shabbat', label:'מוצרי שבת', status:'active' },
    { key:'havdalah', label:'הבדלה', status:'active' },
    { key:'gifts', label:'מתנות', status:'active' },
    { key:'silverware', label:'כלי כסף', status:'active' },
  ];
  ...
  const ORDERS = Array.from({length:16}).map((_,i)=>{
    ...
    const items = Array.from({length:itemsCount}).map((_,k)=>{
      ...
      const qty = 1 + ((i+k) % 2);
      return { productId:p.id, name:p.name, cat:p.catLabel, price:p.price, qty };
    });
  ...
  global.BereshitMockData = { PRODUCTS, CATEGORIES, CUSTOMERS, ORDERS, PROMOTIONS, STORE_INFO };
